...
class Category(db.Model):
    ...
    image = db.Column(db.String(60), nullable=False, default = 'category1.jpeg')
...
class Order(db.Model):
    ...
    def __repr__(self):
        str = "id: {}, Status: {}, Firstname: {}, Surname: {}, Email: {}, Phone: {}, Address: {}, Products: {}, Total Cost: {}\n" 
        str =str.format( self.id, self.status,self.firstname,self.surname, self.email, self.phone, self.address, self.products, self.totalcost)
        return str
